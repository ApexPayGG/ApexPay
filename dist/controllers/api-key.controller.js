...
import { ApiKeyNotFoundError, ApiKeyService, } from "../services/api-key.service.js";
...
export class ApiKeyController {
    ...
    async list(req, res) {
        ...
        try {
            ...
            const { items, nextCursor } = await this.apiKeyService.listForUser(userId, cursorStr === undefined ? { limit } : { limit, cursor: cursorStr });
    ...
    async create(req, res) {
        ...
        try {
            ...
            const { fullKeyPlaintext, record } = await this.apiKeyService.createKey(userId, body.name, {
