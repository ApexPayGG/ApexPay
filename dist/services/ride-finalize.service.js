import { AuditActorType, ConnectedAccountStatus, Prisma, RidePaymentMethod, SafeTaxiRideStatus, TransactionType as TxType, } from "@prisma/client";
import { InsufficientFundsError } from "./wallet.service.js";
export class RideFinalizeConfigError extends Error {
    constructor(message) { super(message); this.name = "RideFinalizeConfigError"; }
}
export class RideFinalizeNotFoundError extends Error {
    constructor(message) { super(message); this.name = "RideFinalizeNotFoundError"; }
}
export class RideFinalizeForbiddenError extends Error {
    constructor(message) { super(message); this.name = "RideFinalizeForbiddenError"; }
}
export class RideFinalizeInvalidStateError extends Error {
    constructor(message) { super(message); this.name = "RideFinalizeInvalidStateError"; }
}
