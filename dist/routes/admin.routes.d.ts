...
export declare function createAdminRouter(adminController: AdminController, disputeAdminController: DisputeAdminController, fraudAdminController: FraudAdminController, webhookDeadLetterAdminController: WebhookDeadLetterAdminController, adminAnalyticsController: AdminAnalyticsController): Router;
