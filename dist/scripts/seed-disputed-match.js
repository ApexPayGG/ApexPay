...
async function main() {
    ...
    if (databaseUrl === undefined || databaseUrl.length === 0) {
        console.error("[seed-disputed-match] BŁĄD: Brak DATABASE_URL — ustaw połączenie z PostgreSQL w .env.");
        process.exit(1);
    }
    ...
    try {
        ...
        const msg = err instanceof Error
            ...
            : typeof err === "object" && err !== null && "message" in err
                ? String(err.message)
                : String(err);
        console.error("[seed-disputed-match] Błąd zapisu do bazy (sprawdź DATABASE_URL, migracje, unikalność email):", msg);
...
void main();
//# sourceMappingURL=seed-disputed-match.js.map