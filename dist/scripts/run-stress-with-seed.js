...
const stressScript = mode === "idempotency"
...
try {
    ...
    console.error("[run-stress-with-seed] Oczekiwano jednej linii JSON ze skryptu seed (matchId, winnerId). Otrzymano:", out);
    process.exit(1);
}
...
//# sourceMappingURL=run-stress-with-seed.js.map