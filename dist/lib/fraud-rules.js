...
export async function ruleVelocityCharge(ctx) {
...
export async function ruleVelocityPayout(ctx) {
...
export async function ruleUnusualAmount(ctx) {
...
export async function ruleDuplicateCharge(ctx) {
    if (ctx.entityType !== "MarketplaceCharge") {
        return null;
    }
...
export async function ruleCardTesting(ctx) {
    if (ctx.entityType !== "MarketplaceCharge") {
        return null;
    }
...
export async function ruleAccountAgeTooLow(ctx) {
    if (ctx.entityType !== "MarketplaceCharge") {
        return null;
    }
...
export async function ruleRefundRateTooHigh(ctx) {
    if (ctx.entityType !== "MarketplaceCharge") {
        return null;
    }
...
export async function rulePayoutSpike(ctx) {
    if (ctx.entityType !== "Payout") {
        return null;
    }
