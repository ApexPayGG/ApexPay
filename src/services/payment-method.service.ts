...
function isUniqueProviderTokenViolation(err: unknown): boolean {
...
export function toPublicPaymentMethod(pm: PaymentMethod): Omit<PaymentMethod, "token"> & {
  token: "[redacted]";
} {
  return {
    ...pm,
...
export class PaymentMethodService {
  ...
  async listForUser(userId: string): Promise<PaymentMethod[]> {
