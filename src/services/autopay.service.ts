...
function deepFindByKey(obj: unknown, key: string): string | undefined {
...
export class AutopayService {
  ...
  async parseItn(base64Xml: string): Promise<AutopayItnData> {
