...
export class RideFinalizeService {
    ...
    return this.prisma.$transaction(
      async (tx) => {
        ...
        if (
          ...
          throw new RideFinalizeInvalidStateError("Przejazd nie może być rozliczony w tym stanie.");
        }
  ...
  async assertDurableDuplicate(input: RideFinalizeInput): Promise<void> {
    const rideId = input.rideId.trim();
