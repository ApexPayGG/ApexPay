...
describe("SafeTaxiService.settleRide — CARD guarded debit", () => {
  beforeEach(() => {
    vi.stubEnv("SAFE_TAXI_PLATFORM_USER_ID", "user_platform");
    vi.stubEnv("SAFE_TAXI_PLATFORM_COMMISSION_BPS", "1500");
  });
  ...
  it("rzuca InsufficientFundsError i nie kredytuje driver/platform gdy debet pasażera nie przejdzie", async () => {
    const rideRow = {
      id: "ride_card_1",
      passengerId: "user_pass",
      driverId: "user_driver",
