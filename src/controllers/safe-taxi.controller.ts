...
import {
  ...
  SafeTaxiService,
} from "../services/safe-taxi.service.js";

export class SafeTaxiController {
  constructor(private readonly service: SafeTaxiService) {}
   ...
   */
  async settleRide(req: Request, res: Response): Promise<void> {
    try {
      ...
      const body = req.body as { fareCents?: unknown };
      const fareRaw =
        typeof body.fareCents === "string"
          ? body.fareCents.trim()
