...
const RIDE_FINALIZE_PROCESSING = "processing";
const RIDE_FINALIZE_DONE = "done";
    ...
    try {
      ...
      if (acquiredIdempotencyKey !== null) {
        try {
          ...
          console.error("[payments/ride-finalize] Redis reservation cleanup failed", redisErr);
        }
      }
